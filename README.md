...
The Content library is organized into **Media** (uploaded images and videos), **Widgets** (reusable visual content), and **Data Sources** (reusable data connections). Standalone Website and YouTube Widgets display dashboards, pages, and videos without a YouTube API key; Clock, Date, and QR Code Widgets round out the basics. Data-driven Widgets — Ticker, Menu, List, Table, and Agenda — display a compatible Data Source (Calendar, RSS, Atom, JSON, or CSV) that handles fetching, parsing, caching, and date-aware selection. Widgets and Media can be reused and ordered in playlists and arranged in Layouts. See [Widgets, Data Sources, and Layouts](docs/widgets-and-layouts.md).
