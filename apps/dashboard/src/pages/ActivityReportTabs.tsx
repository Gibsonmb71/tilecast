  ...
  return (
    <>
        ...
        <header>
          ...
          <div className="activity-panel-actions">
            ...
            >
              ...
              <option value="presentation">By Playlist or Layout</option>
              <option value="schedule">By schedule</option>
            </select>
            {canExport && (
              <a
                className="button button--secondary"
                href={`/api/v1/activity/proof-of-play/export.csv?${params}`}
              >
      ...
      <section className="activity-panel">
        <header>
          <div>
            <h3>Detailed proof of play</h3>
            <p>What was actually displayed, where, when, and for how long.</p>
          </div>
        </header>
                  ...
                  <td>
                    <TechnicalDetails
                      value={{
                        ...
                        layoutPlacementId: item.layoutPlacementId,
                        sourceId: item.sourceId,
                        selectedRecordId: item.selectedRecordId,
                        selectionDate: item.selectionDate,
                        sourceCachedAt: item.sourceCachedAt,
        ...
        {!query.data?.items.length && (
          <EmptyState message="No Player-confirmed playback was reported in this range." />
        )}
        <ActivityPagination
    ...
    <section className="activity-panel">
      <header>
        ...
        {canExport && (
          <a
            className="button button--secondary"
            href={`/api/v1/activity/audit/export.csv?${params}`}
          >
            <Download size={15} /> Export CSV
          </a>
        )}
